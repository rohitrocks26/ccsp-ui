...
title = 'app';
  ...
  public username :Input  = new Input("username","","enter username","text");
  public EXtn :Input  = new Input("extension","","enter extn.","text");
  public office :Input  = new Input("office","","enter office location","text");
  public groupItem=[
  {"title": 'BTA', "id": '2'},
